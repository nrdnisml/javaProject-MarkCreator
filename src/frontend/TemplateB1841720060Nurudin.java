 ...
 * @author personal
 */
public class TemplateB1841720060Nurudin extends javax.swing.JFrame {

    /**
     * Creates new form CustomTemplateNurudin
     */
    public TemplateB1841720060Nurudin() {
        initComponents();
...
//        jButtonNavTugas.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TemplateB1841720060Nurudin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TemplateB1841720060Nurudin().setVisible(true);
            }
        });
    }
